...
### Windows
```batch
setx .LAB_DIR "C:\Users\dbaha\Documents\Projects\kicad-library-validator\..\kicad-lab-library\library"
```

### Linux/macOS
```bash
echo 'export .LAB_DIR="C:\Users\dbaha\Documents\Projects\kicad-library-validator\..\kicad-lab-library\library"' >> ~/.bashrc
source ~/.bashrc
```
